...
def main():
    ...
    model_args, data_args, training_args = parser.parse_json_file(json_file=os.path.abspath('Trainer_based/data/args.json'))

    training_args.run_name = 'ADFASD'
