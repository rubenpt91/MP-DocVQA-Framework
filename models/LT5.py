...
from models._modules import CustomT5Config, SpatialEmbeddings
...
class ProxyLT5:
    ...
    def prepare_inputs_for_vqa(self, question, words, boxes, answers=None):
        bs = len(words)
    ...
    def forward(self, batch, return_pred_answer=False):
        ...
        if self.page_retrieval == 'logits':
            ...
            input_embeds, attention_mask, labels = self.prepare_inputs_for_vqa(question, words, boxes, answers)
